          ...
          <div className="col-lg-6">
            ...
            <div className="d-flex align-items-start gap-3 mb-4">
              ...
              <div>
                ...
                <span style={{ color: '#555' }}>Info@goeazymart.in</span>
              </div>
            </div>
            ...
            <div className="d-flex align-items-start gap-3 mb-4">
              <div style={{ width: '40px', height: '40px', background: 'rgba(200, 151, 43, 0.12)', border: '1px solid rgba(200, 151, 43, 0.25)', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '18px', flexShrink: 0 }}>📍</div>
              <div>
                <strong style={{ display: 'block', color: 'var(--gold-light)', fontSize: '13px', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '3px' }}>Registered Office Address</strong>
                <span style={{ color: '#555' }}>No 2/595 Kurinji street IAF post AVADI Chennai 600055</span>
              </div>
            </div>
